...
mongoose.connect(
   "mongodb://node-shop:" +
   process.env.MONGO_ATLAS_PW +
   "@cluster0-shard-00-00-nh4yn.mongodb.net:27017,cluster0-shard-00-01-nh4yn.mongodb.net:27017,cluster0-shard-00-02-nh4yn.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true",
   {
     useMongoClient: true
   }
 );
